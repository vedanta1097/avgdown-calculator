...
- **Modal Tersedia:** Enter how much money you have → get the new average price after buying
- **Target Loss %:** Enter a target floating loss % (e.g. -5%) → get the lots and capital needed to reach it
- **Target Harga Avg:** Enter your desired new average price → get the number of lots and capital required to reach it
- **Floating Loss Comparison:** After calculating, see a side-by-side breakdown of your floating loss (Rp & %) _before_ and _after_ averaging down
...
3. Choose a mode: **Modal Tersedia**, **Target Loss %**, or **Target Harga Avg**
